...
for GRAPH_DIR in "${DIRS[@]}"; do
    ...
    DIR1_OPTIMIZATION="Pagination&Indexing&Caching&N+1Query"
    ...
    python2 /usr/bin/tsplot -d "graphs/all_but_one_vs_all/$GRAPH_DIR" $DIR1_OPTIMIZATION $DIR1 $DIR2_OPTIMIZATION $DIR2
done
